                ...
                <Row>
                                ...
                                return (
                                    <>
                                        ...
                                        <Col xs={6} className="my-3 docment">
                                            <div key={index}>
                                                <p className="">
                                                    <img src="../assets/folder1.png" alt="" width="100%" />
                                                </p>
                    ...
                    <Col xs={12} md={6} className="tezt-ck">
                        <Form>
                            ...
                            />
                            <Form.Select className="form-control form-select mt-1 private" onChange={(e) => alert(e.target.value)} size="lg">
